...
class MyPDFHandler(object):
    ...
    def add_one_bookmark(self,
        ...
        :return: None
        '''
        bookmark = self.__writeable_pdf.addBookmark(title,
                                                    page - 1,
                                                    parent=parent,
                                                    color=color,
                                                    fit=fit)
...
def main():
    pdf_handler = MyPDFHandler(
        u'C:/N-20L6PF1PYK28-Data/barretr/Desktop/TCPIP详解卷一.pdf',
        PDFHandleMode.NEWLY)
    pdf_handler.add_bookmarks_by_read_txt(
        'C:/N-20L6PF1PYK28-Data/barretr/Desktop/1.txt')
    pdf_handler.save2file(
        u'C:/N-20L6PF1PYK28-Data/barretr/Desktop/TCPIP详解卷一-目录书签版.pdf')
